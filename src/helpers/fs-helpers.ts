...
// Matches /* followed by any characters (non-greedy), including newlines,
// until the first occurrence of */, ensuring 'Generated by sg-schema-sync' is present.
const generatedBannerRegex = /\/\*[\s\S]*?Generated by sg-schema-sync[\s\S]*?\*\//m;
